...
const char PROGMEM MSG_CALIBRATE_SENSORS[] = "Calibrate";
const char PROGMEM MSG_TEST_PERIPHERALS[] = "Test peripherals";
...
const char PROGMEM MSG_SLOT_NAME[] = "Name";
...
const char PROGMEM MSG_FEEDING_SCHEDULE[] = "Schedule";
const char PROGMEM MSG_MAX_DAILY_WATER[] = "Max daily water";
...
const char PROGMEM MSG_MIN_RUNTIME[] = "Set minimum volume";
const char PROGMEM MSG_MAX_RUNTIME[] = "Set max volume";
...
const char PROGMEM MSG_START_MIN[] = "Start min";
const char PROGMEM MSG_START_TIME[] = "Start";
const char PROGMEM MSG_HOUR[] = "Hour";
